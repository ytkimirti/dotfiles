...
function getProjectGitUrl(url, onComplete) {
    ...
    fetch(url, {
        ...
        const gitUrlElement = htmlDoc.querySelector("div.team-repo > div > input")
        if (!gitUrlElement)
            return;
        ...
        if (onComplete)
            onComplete(gitUrlElement.value);
...
(function () {
    ...
    $(function () {
        ...
        if (url_base == "profile") {
            ...
            const project_item = $("body > div.page > div.page-content.page-content-fluid > div > div.align-top > div > div.container-fullsize.full-width.fixed-height > div > div:nth-child(5) > div > div")
            ...
            links.append(function (index, str) {
                ...
                const new_object = $(`<a style="float: right; margin-left: 5px;">Copy URL</a>`)
            ...
            if (command_name == "click_subject") {
                ...
                const subject_link = $("#project-show > div.project-main > div.project-summary > div:nth-child(3) > div > div > h4 > a")
                //subject_link.attr("target", "")
                subject_link[0].click()

                $("body > div.main-navbar > div.main-navbar-left > div > a > img")[0].click()
            }
        }
